...
if (isset($_GET['code'])) {
    ...
    //thong ke doanh thu
    $sql_lietke_dh = "SELECT * FROM tbl_cart_details,tbl_product WHERE tbl_cart_details.pdt_id=tbl_product.pdt_id AND tbl_cart_details.code_cart='$code_cart' ORDER BY tbl_cart_details.cart_details_id DESC";
    ...
    while ($row = mysqli_fetch_array($query_lietke_dh)) {
        ...
        //   $doanhthu+=$row['pdt_price'];
        $soluongmua += $row['soluongmua'];
        $doanhthu = $doanhthu + $row['pdt_price'] * $row['soluongmua'];
    }
